...
{
    /// <summary>
    /// AMQP API for conference.say
    /// </summary>
    [DataContract]
    public partial class KapiConferenceSay :  IEquatable<KapiConferenceSay>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiConferenceSay {\n");
        ...
        {
            return this.Equals(input as KapiConferenceSay);
        }

        /// <summary>
        /// Returns true if KapiConferenceSay instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiConferenceSay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiConferenceSay input)
        {
            if (input == null)
                return false;
