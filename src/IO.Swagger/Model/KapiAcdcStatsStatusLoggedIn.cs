...
{
    /// <summary>
    /// AMQP API for acdc_stats.status_logged_in
    /// </summary>
    [DataContract]
    public partial class KapiAcdcStatsStatusLoggedIn :  IEquatable<KapiAcdcStatsStatusLoggedIn>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusLoggedIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcStatsStatusLoggedIn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusLoggedIn" /> class.
        /// </summary>
        ...
        public KapiAcdcStatsStatusLoggedIn(string accountID = default(string), string agentID = default(string), string callID = default(string), string callerIDName = default(string), string callerIDNumber = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), int? pauseTime = default(int?), string queueID = default(string), string timestamp = default(string), int? waitTime = default(int?))
        {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcStatsStatusLoggedIn and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for KapiAcdcStatsStatusLoggedIn and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcStatsStatusLoggedIn {\n");
        ...
        {
            return this.Equals(input as KapiAcdcStatsStatusLoggedIn);
        }

        /// <summary>
        /// Returns true if KapiAcdcStatsStatusLoggedIn instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcStatsStatusLoggedIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcStatsStatusLoggedIn input)
        {
            if (input == null)
                return false;
