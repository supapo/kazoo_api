...
{
    /// <summary>
    /// AMQP API for dialplan.play_macro
    /// </summary>
    [DataContract]
    public partial class KapiDialplanPlayMacro :  IEquatable<KapiDialplanPlayMacro>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ApplicationNameEnum
        {
            ...
            /// <summary>
            /// Enum Playmacro for value: play_macro
            /// </summary>
            [EnumMember(Value = "play_macro")]
            Playmacro = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanPlayMacro" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiDialplanPlayMacro() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanPlayMacro" /> class.
        /// </summary>
        ...
        public KapiDialplanPlayMacro(ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), InsertAtEnum? insertAt = default(InsertAtEnum?), string mediaMacro = default(string))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiDialplanPlayMacro and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiDialplanPlayMacro and cannot be null");
            }
            else
            {
                this.CallID = callID;
            ...
            if (mediaMacro == null)
            {
                throw new InvalidDataException("mediaMacro is a required property for KapiDialplanPlayMacro and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanPlayMacro {\n");
        ...
        {
            return this.Equals(input as KapiDialplanPlayMacro);
        }

        /// <summary>
        /// Returns true if KapiDialplanPlayMacro instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanPlayMacro to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanPlayMacro input)
        {
            if (input == null)
                return false;
