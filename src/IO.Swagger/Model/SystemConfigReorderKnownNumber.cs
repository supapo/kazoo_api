...
{
    /// <summary>
    /// setting for how to response if the number is known but unconfigured
    /// </summary>
    [DataContract]
    public partial class SystemConfigReorderKnownNumber :  IEquatable<SystemConfigReorderKnownNumber>, IValidatableObject
    {
        /// <summary>
        /// the action to take for unconfigured numbers
        /// </summary>
        /// <value>the action to take for unconfigured numbers</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemConfigReorderKnownNumber" /> class.
        /// </summary>
        /// <param name="action">the action to take for unconfigured numbers (default to ActionEnum.Respond).</param>
        /// <param name="bridgeAccountId">the account id that the bridge_device_id belongs to.</param>
        /// <param name="bridgeDeviceId">the device id to bridge unconfigured numbers to.</param>
        /// <param name="responseCode">reorder code for replies to unconfigured numbers (default to &quot;686&quot;).</param>
        /// <param name="responseMessage">reorder message for replies to unconfigured numbers (default to &quot;PICNIC&quot;).</param>
        /// <param name="transferTarget">onnet phone number to transfer unconfigured numbers to.</param>
        public SystemConfigReorderKnownNumber(ActionEnum? action = ActionEnum.Respond, string bridgeAccountId = default(string), string bridgeDeviceId = default(string), string responseCode = "686", string responseMessage = "PICNIC", string transferTarget = default(string))
        {
        ...
        /// <summary>
        /// the device id to bridge unconfigured numbers to
        /// </summary>
        /// <value>the device id to bridge unconfigured numbers to</value>
        [DataMember(Name="bridge_device_id", EmitDefaultValue=false)]
        public string BridgeDeviceId { get; set; }

        /// <summary>
        /// reorder code for replies to unconfigured numbers
        /// </summary>
        /// <value>reorder code for replies to unconfigured numbers</value>
        [DataMember(Name="response_code", EmitDefaultValue=false)]
        public string ResponseCode { get; set; }

        /// <summary>
        /// reorder message for replies to unconfigured numbers
        /// </summary>
        /// <value>reorder message for replies to unconfigured numbers</value>
        [DataMember(Name="response_message", EmitDefaultValue=false)]
        public string ResponseMessage { get; set; }

        /// <summary>
        /// onnet phone number to transfer unconfigured numbers to
        /// </summary>
        /// <value>onnet phone number to transfer unconfigured numbers to</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemConfigReorderKnownNumber {\n");
        ...
        {
            return this.Equals(input as SystemConfigReorderKnownNumber);
        }

        /// <summary>
        /// Returns true if SystemConfigReorderKnownNumber instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemConfigReorderKnownNumber to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemConfigReorderKnownNumber input)
        {
            if (input == null)
                return false;
