...
{
    /// <summary>
    /// AMQP API for dialplan.respond
    /// </summary>
    [DataContract]
    public partial class KapiDialplanRespond :  IEquatable<KapiDialplanRespond>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanRespond" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiDialplanRespond() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanRespond" /> class.
        /// </summary>
        ...
        public KapiDialplanRespond(ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), InsertAtEnum? insertAt = default(InsertAtEnum?), string responseCode = default(string), string responseMessage = default(string))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiDialplanRespond and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiDialplanRespond and cannot be null");
            }
            else
            {
                this.CallID = callID;
            ...
            {
                throw new InvalidDataException("responseCode is a required property for KapiDialplanRespond and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanRespond {\n");
        ...
        {
            return this.Equals(input as KapiDialplanRespond);
        }

        /// <summary>
        /// Returns true if KapiDialplanRespond instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanRespond to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanRespond input)
        {
            if (input == null)
                return false;
