...
{
    /// <summary>
    /// Schema for notify.first_occurrence system_config
    /// </summary>
    [DataContract]
    public partial class SystemConfigNotifyFirstOccurrence :  IEquatable<SystemConfigNotifyFirstOccurrence>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemConfigNotifyFirstOccurrence" /> class.
        /// </summary>
        /// <param name="defaultTo">notify.first_occurrence default to.</param>
        /// <param name="htmlContentTransferEncoding">notify.first_occurrence html content transfer encoding (default to &quot;7BIT&quot;).</param>
        /// <param name="textContentTransferEncoding">notify.first_occurrence text content transfer encoding (default to &quot;7BIT&quot;).</param>
        public SystemConfigNotifyFirstOccurrence(Object defaultTo = default(Object), string htmlContentTransferEncoding = "7BIT", string textContentTransferEncoding = "7BIT")
        {
        ...
        /// <summary>
        /// notify.first_occurrence default to
        /// </summary>
        /// <value>notify.first_occurrence default to</value>
        [DataMember(Name="default_to", EmitDefaultValue=false)]
        public Object DefaultTo { get; set; }

        /// <summary>
        /// notify.first_occurrence html content transfer encoding
        /// </summary>
        /// <value>notify.first_occurrence html content transfer encoding</value>
        [DataMember(Name="html_content_transfer_encoding", EmitDefaultValue=false)]
        public string HtmlContentTransferEncoding { get; set; }

        /// <summary>
        /// notify.first_occurrence text content transfer encoding
        /// </summary>
        /// <value>notify.first_occurrence text content transfer encoding</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemConfigNotifyFirstOccurrence {\n");
        ...
        {
            return this.Equals(input as SystemConfigNotifyFirstOccurrence);
        }

        /// <summary>
        /// Returns true if SystemConfigNotifyFirstOccurrence instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemConfigNotifyFirstOccurrence to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemConfigNotifyFirstOccurrence input)
        {
            if (input == null)
                return false;
