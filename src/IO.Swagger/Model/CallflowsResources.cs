...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsResources :  IEquatable<CallflowsResources>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsResources" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsResources {\n");
        ...
        {
            return this.Equals(input as CallflowsResources);
        }

        /// <summary>
        /// Returns true if CallflowsResources instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsResources to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsResources input)
        {
            if (input == null)
                return false;
