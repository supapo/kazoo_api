...
{
    /// <summary>
    /// AMQP API for dialplan.send_dtmf
    /// </summary>
    [DataContract]
    public partial class KapiDialplanSendDtmf :  IEquatable<KapiDialplanSendDtmf>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ApplicationNameEnum
        {
            ...
            /// <summary>
            /// Enum Senddtmf for value: send_dtmf
            /// </summary>
        ...
        protected KapiDialplanSendDtmf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanSendDtmf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanSendDtmf {\n");
        ...
        {
            return this.Equals(input as KapiDialplanSendDtmf);
        }

        /// <summary>
        /// Returns true if KapiDialplanSendDtmf instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanSendDtmf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanSendDtmf input)
        {
            if (input == null)
                return false;
