...
{
    /// <summary>
    /// AMQP API for acdc_agent.pause
    /// </summary>
    [DataContract]
    public partial class KapiAcdcAgentPause :  IEquatable<KapiAcdcAgentPause>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentPause" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcAgentPause() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentPause" /> class.
        /// </summary>
        ...
        public KapiAcdcAgentPause(string accountID = default(string), string agentID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string presenceID = default(string), PresenceStateEnum? presenceState = default(PresenceStateEnum?), string queueID = default(string), int? timeLimit = default(int?))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiAcdcAgentPause and cannot be null");
            }
            else
            {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcAgentPause and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcAgentPause {\n");
        ...
        {
            return this.Equals(input as KapiAcdcAgentPause);
        }

        /// <summary>
        /// Returns true if KapiAcdcAgentPause instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcAgentPause to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcAgentPause input)
        {
            if (input == null)
                return false;
