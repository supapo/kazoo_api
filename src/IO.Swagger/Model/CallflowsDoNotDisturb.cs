...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsDoNotDisturb :  IEquatable<CallflowsDoNotDisturb>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsDoNotDisturb" /> class.
        /// </summary>
        /// <param name="action">What action to perform.</param>
        /// <param name="id">Document ID on which to update DND settings.</param>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsDoNotDisturb(ActionEnum? action = default(ActionEnum?), string id = default(string), bool? skipModule = default(bool?))
        {
            this.Action = action;
            this.Id = id;
        ...
        /// <summary>
        /// Document ID on which to update DND settings
        /// </summary>
        /// <value>Document ID on which to update DND settings</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsDoNotDisturb {\n");
        ...
        {
            return this.Equals(input as CallflowsDoNotDisturb);
        }

        /// <summary>
        /// Returns true if CallflowsDoNotDisturb instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsDoNotDisturb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsDoNotDisturb input)
        {
            if (input == null)
                return false;
