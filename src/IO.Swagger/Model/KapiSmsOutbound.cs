...
{
    /// <summary>
    /// AMQP API for sms.outbound
    /// </summary>
    [DataContract]
    public partial class KapiSmsOutbound :  IEquatable<KapiSmsOutbound>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiSmsOutbound" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiSmsOutbound() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiSmsOutbound" /> class.
        /// </summary>
        ...
        public KapiSmsOutbound(string accountID = default(string), string body = default(string), string calleeIDName = default(string), string calleeIDNumber = default(string), string callerIDName = default(string), string callerIDNumber = default(string), string contact = default(string), string contactIP = default(string), string contactPort = default(string), string contactUsername = default(string), Object customChannelVars = default(Object), Object customSIPHeaders = default(Object), string deliveryFailure = default(string), string deliveryResultCode = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string eventQueue = default(string), string from = default(string), string fromNetworkAddr = default(string), string geoLocation = default(string), string messageID = default(string), string origIP = default(string), string origPort = default(string), string request = default(string), string routeID = default(string), RouteTypeEnum? routeType = default(RouteTypeEnum?), string status = default(string), string switchHostname = default(string), string switchNodename = default(string), string systemID = default(string), string to = default(string), string userAgent = default(string))
        {
            ...
            {
                throw new InvalidDataException("calleeIDNumber is a required property for KapiSmsOutbound and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("callerIDNumber is a required property for KapiSmsOutbound and cannot be null");
            }
            else
            {
            ...
            if (messageID == null)
            {
                throw new InvalidDataException("messageID is a required property for KapiSmsOutbound and cannot be null");
            }
            else
            {
            ...
            if (routeID == null)
            {
                throw new InvalidDataException("routeID is a required property for KapiSmsOutbound and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiSmsOutbound {\n");
        ...
        {
            return this.Equals(input as KapiSmsOutbound);
        }

        /// <summary>
        /// Returns true if KapiSmsOutbound instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiSmsOutbound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiSmsOutbound input)
        {
            if (input == null)
                return false;
