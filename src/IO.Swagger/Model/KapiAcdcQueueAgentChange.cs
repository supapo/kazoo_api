...
{
    /// <summary>
    /// AMQP API for acdc_queue.agent_change
    /// </summary>
    [DataContract]
    public partial class KapiAcdcQueueAgentChange :  IEquatable<KapiAcdcQueueAgentChange>, IValidatableObject
    {
        /// <summary>
        /// Defines Change
        /// </summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Agentchange for value: agent_change
            /// </summary>
            [EnumMember(Value = "agent_change")]
            Agentchange = 1
        }
        ...
        protected KapiAcdcQueueAgentChange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcQueueAgentChange" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcQueueAgentChange {\n");
        ...
        {
            return this.Equals(input as KapiAcdcQueueAgentChange);
        }

        /// <summary>
        /// Returns true if KapiAcdcQueueAgentChange instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcQueueAgentChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcQueueAgentChange input)
        {
            if (input == null)
                return false;
