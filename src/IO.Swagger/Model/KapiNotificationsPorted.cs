...
{
    /// <summary>
    /// AMQP API for notifications.ported
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsPorted :  IEquatable<KapiNotificationsPorted>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPorted" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiNotificationsPorted() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPorted" /> class.
        /// </summary>
        ...
        public KapiNotificationsPorted(string accountDB = default(string), string accountID = default(string), string attachmentURL = default(string), string authorizedBy = default(string), string bcc = default(string), string cc = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string from = default(string), string hTML = default(string), string localNumber = default(string), string number = default(string), string numberState = default(string), string port = default(string), string portRequestID = default(string), string preview = default(string), Object reason = default(Object), string replyTo = default(string), string request = default(string), string subject = default(string), string text = default(string), string to = default(string), string version = default(string))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiNotificationsPorted and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsPorted {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsPorted);
        }

        /// <summary>
        /// Returns true if KapiNotificationsPorted instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsPorted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsPorted input)
        {
            if (input == null)
                return false;
