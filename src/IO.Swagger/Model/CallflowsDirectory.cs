...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsDirectory :  IEquatable<CallflowsDirectory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsDirectory" /> class.
        /// </summary>
        ...
        public CallflowsDirectory(string id = default(string), bool? skipModule = default(bool?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsDirectory {\n");
        ...
        {
            return this.Equals(input as CallflowsDirectory);
        }

        /// <summary>
        /// Returns true if CallflowsDirectory instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsDirectory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsDirectory input)
        {
            if (input == null)
                return false;
