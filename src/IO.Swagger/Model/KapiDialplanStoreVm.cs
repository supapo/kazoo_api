...
{
    /// <summary>
    /// AMQP API for dialplan.store_vm
    /// </summary>
    [DataContract]
    public partial class KapiDialplanStoreVm :  IEquatable<KapiDialplanStoreVm>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ApplicationNameEnum
        {
            ...
            /// <summary>
            /// Enum Storevm for value: store_vm
            /// </summary>
            [EnumMember(Value = "store_vm")]
            Storevm = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanStoreVm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiDialplanStoreVm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanStoreVm" /> class.
        /// </summary>
        ...
        public KapiDialplanStoreVm(List<string> additionalHeaders = default(List<string>), ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), InsertAtEnum? insertAt = default(InsertAtEnum?), string mediaName = default(string), string mediaTransferDestination = default(string), MediaTransferMethodEnum mediaTransferMethod = default(MediaTransferMethodEnum), bool? suppressErrorReport = default(bool?))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiDialplanStoreVm and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiDialplanStoreVm and cannot be null");
            }
            else
            {
                this.CallID = callID;
            ...
            if (mediaName == null)
            {
                throw new InvalidDataException("mediaName is a required property for KapiDialplanStoreVm and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("mediaTransferDestination is a required property for KapiDialplanStoreVm and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("mediaTransferMethod is a required property for KapiDialplanStoreVm and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanStoreVm {\n");
        ...
        {
            return this.Equals(input as KapiDialplanStoreVm);
        }

        /// <summary>
        /// Returns true if KapiDialplanStoreVm instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanStoreVm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanStoreVm input)
        {
            if (input == null)
                return false;
