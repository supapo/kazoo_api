...
{
    /// <summary>
    /// AMQP API for acdc_stats.status_outbound
    /// </summary>
    [DataContract]
    public partial class KapiAcdcStatsStatusOutbound :  IEquatable<KapiAcdcStatsStatusOutbound>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusOutbound" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcStatsStatusOutbound() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusOutbound" /> class.
        /// </summary>
        ...
        public KapiAcdcStatsStatusOutbound(string accountID = default(string), string agentID = default(string), string callID = default(string), string callerIDName = default(string), string callerIDNumber = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), int? pauseTime = default(int?), string queueID = default(string), string timestamp = default(string), int? waitTime = default(int?))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiAcdcStatsStatusOutbound and cannot be null");
            }
            else
            {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcStatsStatusOutbound and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for KapiAcdcStatsStatusOutbound and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcStatsStatusOutbound {\n");
        ...
        {
            return this.Equals(input as KapiAcdcStatsStatusOutbound);
        }

        /// <summary>
        /// Returns true if KapiAcdcStatsStatusOutbound instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcStatsStatusOutbound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcStatsStatusOutbound input)
        {
            if (input == null)
                return false;
