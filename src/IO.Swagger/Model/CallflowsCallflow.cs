...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsCallflow :  IEquatable<CallflowsCallflow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsCallflow" /> class.
        /// </summary>
        /// <param name="id">The Callflow ID to branch to.</param>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsCallflow(string id = default(string), bool? skipModule = default(bool?))
        {
            this.Id = id;
        ...
        /// <summary>
        /// The Callflow ID to branch to
        /// </summary>
        /// <value>The Callflow ID to branch to</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsCallflow {\n");
        ...
        {
            return this.Equals(input as CallflowsCallflow);
        }

        /// <summary>
        /// Returns true if CallflowsCallflow instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsCallflow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsCallflow input)
        {
            if (input == null)
                return false;
