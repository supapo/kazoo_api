...
{
    /// <summary>
    /// AMQP API for resource.originate_req_endpoint_headers
    /// </summary>
    [DataContract]
    public partial class KapiResourceOriginateReqEndpointHeaders :  IEquatable<KapiResourceOriginateReqEndpointHeaders>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiResourceOriginateReqEndpointHeaders" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiResourceOriginateReqEndpointHeaders() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiResourceOriginateReqEndpointHeaders" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiResourceOriginateReqEndpointHeaders {\n");
        ...
        {
            return this.Equals(input as KapiResourceOriginateReqEndpointHeaders);
        }

        /// <summary>
        /// Returns true if KapiResourceOriginateReqEndpointHeaders instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiResourceOriginateReqEndpointHeaders to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiResourceOriginateReqEndpointHeaders input)
        {
            if (input == null)
                return false;
