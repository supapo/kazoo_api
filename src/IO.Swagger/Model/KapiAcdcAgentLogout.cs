...
{
    /// <summary>
    /// AMQP API for acdc_agent.logout
    /// </summary>
    [DataContract]
    public partial class KapiAcdcAgentLogout :  IEquatable<KapiAcdcAgentLogout>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentLogout" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcAgentLogout() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentLogout" /> class.
        /// </summary>
        ...
        public KapiAcdcAgentLogout(string accountID = default(string), string agentID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string presenceID = default(string), PresenceStateEnum? presenceState = default(PresenceStateEnum?), string queueID = default(string), int? timeLimit = default(int?))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiAcdcAgentLogout and cannot be null");
            }
            else
            {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcAgentLogout and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcAgentLogout {\n");
        ...
        {
            return this.Equals(input as KapiAcdcAgentLogout);
        }

        /// <summary>
        /// Returns true if KapiAcdcAgentLogout instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcAgentLogout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcAgentLogout input)
        {
            if (input == null)
                return false;
