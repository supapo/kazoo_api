...
{
    /// <summary>
    /// AMQP API for notifications.outbound_fax
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsOutboundFax :  IEquatable<KapiNotificationsOutboundFax>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Outboundfax for value: outbound_fax
            /// </summary>
            [EnumMember(Value = "outbound_fax")]
            Outboundfax = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsOutboundFax" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiNotificationsOutboundFax() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsOutboundFax" /> class.
        /// </summary>
        ...
        /// <param name="faxID">faxID (required).</param>
        /// <param name="faxInfo">faxInfo.</param>
        /// <param name="faxJobId">faxJobId (required).</param>
        ...
        public KapiNotificationsOutboundFax(string accountDB = default(string), string accountID = default(string), string attachmentURL = default(string), string bcc = default(string), string callID = default(string), string calleeIDName = default(string), string calleeIDNumber = default(string), string callerIDName = default(string), string callerIDNumber = default(string), string cc = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string faxID = default(string), string faxInfo = default(string), string faxJobId = default(string), string faxNotifications = default(string), string faxTimestamp = default(string), string faxBoxID = default(string), string from = default(string), string hTML = default(string), string ownerID = default(string), string preview = default(string), string replyTo = default(string), string subject = default(string), string text = default(string), string to = default(string))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiNotificationsOutboundFax and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("calleeIDNumber is a required property for KapiNotificationsOutboundFax and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("callerIDNumber is a required property for KapiNotificationsOutboundFax and cannot be null");
            }
            else
            {
            ...
            if (faxID == null)
            {
                throw new InvalidDataException("faxID is a required property for KapiNotificationsOutboundFax and cannot be null");
            }
            else
            {
                this.FaxID = faxID;
            }
            // to ensure "faxJobId" is required (not null)
            if (faxJobId == null)
            {
                throw new InvalidDataException("faxJobId is a required property for KapiNotificationsOutboundFax and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets FaxJobId
        /// </summary>
        [DataMember(Name="Fax-JobId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsOutboundFax {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsOutboundFax);
        }

        /// <summary>
        /// Returns true if KapiNotificationsOutboundFax instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsOutboundFax to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsOutboundFax input)
        {
            if (input == null)
                return false;
