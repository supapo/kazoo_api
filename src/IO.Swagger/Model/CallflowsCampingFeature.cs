...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsCampingFeature :  IEquatable<CallflowsCampingFeature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsCampingFeature" /> class.
        /// </summary>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsCampingFeature(bool? skipModule = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsCampingFeature {\n");
        ...
        {
            return this.Equals(input as CallflowsCampingFeature);
        }

        /// <summary>
        /// Returns true if CallflowsCampingFeature instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsCampingFeature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsCampingFeature input)
        {
            if (input == null)
                return false;
