...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NotificationsBcc :  IEquatable<NotificationsBcc>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationsBcc" /> class.
        /// </summary>
        /// <param name="emailAddresses">BCC Email Addresses.</param>
        /// <param name="type">type.</param>
        public NotificationsBcc(List<string> emailAddresses = default(List<string>), TypeEnum? type = default(TypeEnum?))
        {
        ...
        /// BCC Email Addresses
        /// </summary>
        /// <value>BCC Email Addresses</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotificationsBcc {\n");
        ...
        {
            return this.Equals(input as NotificationsBcc);
        }

        /// <summary>
        /// Returns true if NotificationsBcc instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationsBcc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationsBcc input)
        {
            if (input == null)
                return false;
