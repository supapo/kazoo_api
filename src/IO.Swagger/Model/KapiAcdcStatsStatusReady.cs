...
{
    /// <summary>
    /// AMQP API for acdc_stats.status_ready
    /// </summary>
    [DataContract]
    public partial class KapiAcdcStatsStatusReady :  IEquatable<KapiAcdcStatsStatusReady>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusReady" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcStatsStatusReady() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusReady" /> class.
        /// </summary>
        ...
        public KapiAcdcStatsStatusReady(string accountID = default(string), string agentID = default(string), string callID = default(string), string callerIDName = default(string), string callerIDNumber = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), int? pauseTime = default(int?), string queueID = default(string), string timestamp = default(string), int? waitTime = default(int?))
        {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcStatsStatusReady and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for KapiAcdcStatsStatusReady and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcStatsStatusReady {\n");
        ...
        {
            return this.Equals(input as KapiAcdcStatsStatusReady);
        }

        /// <summary>
        /// Returns true if KapiAcdcStatsStatusReady instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcStatsStatusReady to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcStatsStatusReady input)
        {
            if (input == null)
                return false;
