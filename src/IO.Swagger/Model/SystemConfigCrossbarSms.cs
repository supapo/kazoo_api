...
{
    /// <summary>
    /// Schema for crossbar.sms system_config
    /// </summary>
    [DataContract]
    public partial class SystemConfigCrossbarSms :  IEquatable<SystemConfigCrossbarSms>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemConfigCrossbarSms" /> class.
        /// </summary>
        ...
        public SystemConfigCrossbarSms(bool? apiE164ConvertFrom = false, bool? apiE164ConvertTo = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemConfigCrossbarSms {\n");
        ...
        {
            return this.Equals(input as SystemConfigCrossbarSms);
        }

        /// <summary>
        /// Returns true if SystemConfigCrossbarSms instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemConfigCrossbarSms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemConfigCrossbarSms input)
        {
            if (input == null)
                return false;
