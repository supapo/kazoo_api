...
{
    /// <summary>
    /// AMQP API for notifications.cf_notification
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsCfNotification :  IEquatable<KapiNotificationsCfNotification>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Cfnotification for value: cf_notification
            /// </summary>
            [EnumMember(Value = "cf_notification")]
            Cfnotification = 1
        }
        ...
        /// <summary>
        /// Gets or Sets NotificationMedia
        /// </summary>
        [DataMember(Name="Notification-Media", EmitDefaultValue=false)]
        public NotificationMediaEnum? NotificationMedia { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsCfNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiNotificationsCfNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsCfNotification" /> class.
        /// </summary>
        ...
        /// <param name="callBridged">callBridged.</param>
        ...
        /// <param name="messageLeft">messageLeft.</param>
        /// <param name="notificationMedia">notificationMedia.</param>
        ...
        public KapiNotificationsCfNotification(string accountDB = default(string), string accountID = default(string), string attachmentURL = default(string), string bcc = default(string), string callBridged = default(string), string callID = default(string), string callerIDName = default(string), string callerIDNumber = default(string), string cc = default(string), string comments = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string from = default(string), string fromRealm = default(string), string fromUser = default(string), string hTML = default(string), int? messageLeft = default(int?), NotificationMediaEnum? notificationMedia = default(NotificationMediaEnum?), string notify = default(string), bool? preview = default(bool?), string replyTo = default(string), string subject = default(string), string templateID = default(string), string text = default(string), string timestamp = default(string), string to = default(string), string toRealm = default(string), string toUser = default(string))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiNotificationsCfNotification and cannot be null");
            }
            else
            {
            ...
            if (templateID == null)
            {
                throw new InvalidDataException("templateID is a required property for KapiNotificationsCfNotification and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsCfNotification {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsCfNotification);
        }

        /// <summary>
        /// Returns true if KapiNotificationsCfNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsCfNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsCfNotification input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.NotificationMedia.Equals(input.NotificationMedia))
                ) && 
                (
