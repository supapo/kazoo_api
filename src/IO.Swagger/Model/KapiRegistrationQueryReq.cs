...
{
    /// <summary>
    /// AMQP API for registration.query_req
    /// </summary>
    [DataContract]
    public partial class KapiRegistrationQueryReq :  IEquatable<KapiRegistrationQueryReq>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Regquery for value: reg_query
            /// </summary>
            [EnumMember(Value = "reg_query")]
            Regquery = 1
        }
        ...
        /// </summary>
        [DataMember(Name="Count-Only", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiRegistrationQueryReq {\n");
        ...
        {
            return this.Equals(input as KapiRegistrationQueryReq);
        }

        /// <summary>
        /// Returns true if KapiRegistrationQueryReq instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiRegistrationQueryReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiRegistrationQueryReq input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CountOnly == input.CountOnly ||
                    (this.CountOnly != null &&
                    this.CountOnly.Equals(input.CountOnly))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CountOnly != null)
                    hashCode = hashCode * 59 + this.CountOnly.GetHashCode();
