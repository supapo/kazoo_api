...
{
    /// <summary>
    /// AMQP API for dialplan.hold_control
    /// </summary>
    [DataContract]
    public partial class KapiDialplanHoldControl :  IEquatable<KapiDialplanHoldControl>, IValidatableObject
    {
        /// <summary>
        /// Defines Action
        /// </summary>
        ...
        public enum ApplicationNameEnum
        {
            ...
            /// <summary>
            /// Enum Holdcontrol for value: hold_control
            /// </summary>
            [EnumMember(Value = "hold_control")]
            Holdcontrol = 1
        }
        ...
        protected KapiDialplanHoldControl() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanHoldControl" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanHoldControl {\n");
        ...
        {
            return this.Equals(input as KapiDialplanHoldControl);
        }

        /// <summary>
        /// Returns true if KapiDialplanHoldControl instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanHoldControl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanHoldControl input)
        {
            if (input == null)
                return false;
