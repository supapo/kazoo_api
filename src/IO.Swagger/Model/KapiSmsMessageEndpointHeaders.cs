...
{
    /// <summary>
    /// AMQP API for sms.message_endpoint_headers
    /// </summary>
    [DataContract]
    public partial class KapiSmsMessageEndpointHeaders :  IEquatable<KapiSmsMessageEndpointHeaders>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiSmsMessageEndpointHeaders" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiSmsMessageEndpointHeaders() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiSmsMessageEndpointHeaders" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiSmsMessageEndpointHeaders {\n");
        ...
        {
            return this.Equals(input as KapiSmsMessageEndpointHeaders);
        }

        /// <summary>
        /// Returns true if KapiSmsMessageEndpointHeaders instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiSmsMessageEndpointHeaders to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiSmsMessageEndpointHeaders input)
        {
            if (input == null)
                return false;
