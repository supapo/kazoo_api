...
{
    /// <summary>
    /// AMQP API for dialplan.tones
    /// </summary>
    [DataContract]
    public partial class KapiDialplanTones :  IEquatable<KapiDialplanTones>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanTones {\n");
        ...
        {
            return this.Equals(input as KapiDialplanTones);
        }

        /// <summary>
        /// Returns true if KapiDialplanTones instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanTones to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanTones input)
        {
            if (input == null)
                return false;
