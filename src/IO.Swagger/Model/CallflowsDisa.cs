...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsDisa :  IEquatable<CallflowsDisa>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsDisa" /> class.
        /// </summary>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsDisa(bool? skipModule = default(bool?))
        {
        ...
        {
            return this.Equals(input as CallflowsDisa);
        }

        /// <summary>
        /// Returns true if CallflowsDisa instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsDisa to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsDisa input)
        {
            if (input == null)
                return false;
