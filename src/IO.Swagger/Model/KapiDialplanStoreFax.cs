...
{
    /// <summary>
    /// AMQP API for dialplan.store_fax
    /// </summary>
    [DataContract]
    public partial class KapiDialplanStoreFax :  IEquatable<KapiDialplanStoreFax>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ApplicationNameEnum
        {
            ...
            /// <summary>
            /// Enum Storefax for value: store_fax
            /// </summary>
            [EnumMember(Value = "store_fax")]
            Storefax = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanStoreFax" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiDialplanStoreFax() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanStoreFax" /> class.
        /// </summary>
        ...
        public KapiDialplanStoreFax(List<string> additionalHeaders = default(List<string>), ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string faxLocalFilename = default(string), InsertAtEnum? insertAt = default(InsertAtEnum?), string mediaTransferDestination = default(string), MediaTransferMethodEnum mediaTransferMethod = default(MediaTransferMethodEnum))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiDialplanStoreFax and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiDialplanStoreFax and cannot be null");
            }
            else
            {
                this.CallID = callID;
            ...
            {
                throw new InvalidDataException("mediaTransferDestination is a required property for KapiDialplanStoreFax and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("mediaTransferMethod is a required property for KapiDialplanStoreFax and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanStoreFax {\n");
        ...
        {
            return this.Equals(input as KapiDialplanStoreFax);
        }

        /// <summary>
        /// Returns true if KapiDialplanStoreFax instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanStoreFax to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanStoreFax input)
        {
            if (input == null)
                return false;
