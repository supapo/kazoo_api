...
{
    /// <summary>
    /// AMQP API for dialplan.answer
    /// </summary>
    [DataContract]
    public partial class KapiDialplanAnswer :  IEquatable<KapiDialplanAnswer>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanAnswer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiDialplanAnswer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanAnswer" /> class.
        /// </summary>
        ...
        public KapiDialplanAnswer(ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), InsertAtEnum? insertAt = default(InsertAtEnum?))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiDialplanAnswer and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiDialplanAnswer and cannot be null");
            }
            else
            {
                this.CallID = callID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanAnswer {\n");
        ...
        {
            return this.Equals(input as KapiDialplanAnswer);
        }

        /// <summary>
        /// Returns true if KapiDialplanAnswer instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanAnswer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanAnswer input)
        {
            if (input == null)
                return false;
