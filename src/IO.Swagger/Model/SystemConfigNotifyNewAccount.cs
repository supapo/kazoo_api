...
{
    /// <summary>
    /// Schema for notify.new_account system_config
    /// </summary>
    [DataContract]
    public partial class SystemConfigNotifyNewAccount :  IEquatable<SystemConfigNotifyNewAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemConfigNotifyNewAccount" /> class.
        /// </summary>
        /// <param name="defaultTo">notify.new_account default to.</param>
        /// <param name="htmlContentTransferEncoding">notify.new_account html content transfer encoding (default to &quot;7BIT&quot;).</param>
        /// <param name="textContentTransferEncoding">notify.new_account text content transfer encoding (default to &quot;7BIT&quot;).</param>
        public SystemConfigNotifyNewAccount(Object defaultTo = default(Object), string htmlContentTransferEncoding = "7BIT", string textContentTransferEncoding = "7BIT")
        {
        ...
        /// <summary>
        /// notify.new_account default to
        /// </summary>
        /// <value>notify.new_account default to</value>
        [DataMember(Name="default_to", EmitDefaultValue=false)]
        public Object DefaultTo { get; set; }

        /// <summary>
        /// notify.new_account html content transfer encoding
        /// </summary>
        /// <value>notify.new_account html content transfer encoding</value>
        [DataMember(Name="html_content_transfer_encoding", EmitDefaultValue=false)]
        public string HtmlContentTransferEncoding { get; set; }

        /// <summary>
        /// notify.new_account text content transfer encoding
        /// </summary>
        /// <value>notify.new_account text content transfer encoding</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemConfigNotifyNewAccount {\n");
        ...
        {
            return this.Equals(input as SystemConfigNotifyNewAccount);
        }

        /// <summary>
        /// Returns true if SystemConfigNotifyNewAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemConfigNotifyNewAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemConfigNotifyNewAccount input)
        {
            if (input == null)
                return false;
