...
{
    /// <summary>
    /// AMQP API for dialplan.progress
    /// </summary>
    [DataContract]
    public partial class KapiDialplanProgress :  IEquatable<KapiDialplanProgress>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanProgress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiDialplanProgress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanProgress" /> class.
        /// </summary>
        ...
        public KapiDialplanProgress(ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), InsertAtEnum? insertAt = default(InsertAtEnum?))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiDialplanProgress and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiDialplanProgress and cannot be null");
            }
            else
            {
                this.CallID = callID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanProgress {\n");
        ...
        {
            return this.Equals(input as KapiDialplanProgress);
        }

        /// <summary>
        /// Returns true if KapiDialplanProgress instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanProgress input)
        {
            if (input == null)
                return false;
