...
{
    /// <summary>
    /// AMQP API for notifications.port_rejected
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsPortRejected :  IEquatable<KapiNotificationsPortRejected>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Portrejected for value: port_rejected
            /// </summary>
            [EnumMember(Value = "port_rejected")]
            Portrejected = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPortRejected" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiNotificationsPortRejected() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPortRejected" /> class.
        /// </summary>
        ...
        public KapiNotificationsPortRejected(string accountDB = default(string), string accountID = default(string), string attachmentURL = default(string), string authorizedBy = default(string), string bcc = default(string), string cc = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string from = default(string), string hTML = default(string), string localNumber = default(string), string number = default(string), string numberState = default(string), string port = default(string), string portRequestID = default(string), string preview = default(string), Object reason = default(Object), string replyTo = default(string), string subject = default(string), string text = default(string), string to = default(string), string version = default(string))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiNotificationsPortRejected and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsPortRejected {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsPortRejected);
        }

        /// <summary>
        /// Returns true if KapiNotificationsPortRejected instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsPortRejected to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsPortRejected input)
        {
            if (input == null)
                return false;
