...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsSkel :  IEquatable<CallflowsSkel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsSkel" /> class.
        /// </summary>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsSkel(bool? skipModule = default(bool?))
        {
        ...
        {
            return this.Equals(input as CallflowsSkel);
        }

        /// <summary>
        /// Returns true if CallflowsSkel instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsSkel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsSkel input)
        {
            if (input == null)
                return false;
