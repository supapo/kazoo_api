...
{
    /// <summary>
    /// AMQP API for notifications.voicemail_full
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsVoicemailFull :  IEquatable<KapiNotificationsVoicemailFull>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Voicemailfull for value: voicemail_full
            /// </summary>
            [EnumMember(Value = "voicemail_full")]
            Voicemailfull = 1
        }
        ...
        protected KapiNotificationsVoicemailFull() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsVoicemailFull" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets MaxMessageCount
        /// </summary>
        [DataMember(Name="Max-Message-Count", EmitDefaultValue=false)]
        public string MaxMessageCount { get; set; }

        /// <summary>
        /// Gets or Sets MessageCount
        /// </summary>
        [DataMember(Name="Message-Count", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsVoicemailFull {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsVoicemailFull);
        }

        /// <summary>
        /// Returns true if KapiNotificationsVoicemailFull instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsVoicemailFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsVoicemailFull input)
        {
            if (input == null)
                return false;
