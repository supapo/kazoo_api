...
{
    /// <summary>
    /// AMQP API for dialplan.media_macro
    /// </summary>
    [DataContract]
    public partial class KapiDialplanMediaMacro :  IEquatable<KapiDialplanMediaMacro>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ApplicationNameEnum
        {
            ...
            /// <summary>
            /// Enum Mediamacro for value: media_macro
            /// </summary>
            [EnumMember(Value = "media_macro")]
            Mediamacro = 1
        }
        ...
        protected KapiDialplanMediaMacro() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanMediaMacro" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets MediaMacros
        /// </summary>
        [DataMember(Name="Media-Macros", EmitDefaultValue=false)]
        public Object MediaMacros { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanMediaMacro {\n");
            sb.Append("  ApplicationName: ").Append(ApplicationName).Append("\n");
            sb.Append("  CallID: ").Append(CallID).Append("\n");
            sb.Append("  EventCategory: ").Append(EventCategory).Append("\n");
            sb.Append("  EventName: ").Append(EventName).Append("\n");
            sb.Append("  InsertAt: ").Append(InsertAt).Append("\n");
            sb.Append("  MediaMacros: ").Append(MediaMacros).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as KapiDialplanMediaMacro);
        }

        /// <summary>
        /// Returns true if KapiDialplanMediaMacro instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanMediaMacro to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanMediaMacro input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MediaMacros == input.MediaMacros ||
                    (this.MediaMacros != null &&
                    this.MediaMacros.Equals(input.MediaMacros))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MediaMacros != null)
                    hashCode = hashCode * 59 + this.MediaMacros.GetHashCode();
                return hashCode;
            }
        }
