...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsIntercept :  IEquatable<CallflowsIntercept>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsIntercept" /> class.
        /// </summary>
        ...
        /// <param name="deviceId">Device to intercept.</param>
        /// <param name="groupId">Group in which to find a call to intercept.</param>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        /// <param name="userId">User in which to find a call to intercept.</param>
        public CallflowsIntercept(string approvedDeviceId = default(string), string approvedGroupId = default(string), string approvedUserId = default(string), string deviceId = default(string), string groupId = default(string), bool? skipModule = default(bool?), string userId = default(string))
        {
        ...
        /// Device to intercept
        /// </summary>
        /// <value>Device to intercept</value>
        [DataMember(Name="device_id", EmitDefaultValue=false)]
        public string DeviceId { get; set; }

        /// <summary>
        /// Group in which to find a call to intercept
        /// </summary>
        /// <value>Group in which to find a call to intercept</value>
        ...
        /// <summary>
        /// User in which to find a call to intercept
        /// </summary>
        /// <value>User in which to find a call to intercept</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsIntercept {\n");
        ...
        {
            return this.Equals(input as CallflowsIntercept);
        }

        /// <summary>
        /// Returns true if CallflowsIntercept instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsIntercept to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsIntercept input)
        {
            if (input == null)
                return false;
