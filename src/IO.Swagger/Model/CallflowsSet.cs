...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsSet :  IEquatable<CallflowsSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsSet" /> class.
        /// </summary>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsSet(bool? skipModule = default(bool?))
        {
        ...
        {
            return this.Equals(input as CallflowsSet);
        }

        /// <summary>
        /// Returns true if CallflowsSet instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsSet input)
        {
            if (input == null)
                return false;
