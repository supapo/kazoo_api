...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsReceiveFax :  IEquatable<CallflowsReceiveFax>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsReceiveFax" /> class.
        /// </summary>
        /// <param name="media">media.</param>
        /// <param name="ownerId">User ID to send fax to.</param>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsReceiveFax(CallflowsFaxboxMedia media = default(CallflowsFaxboxMedia), string ownerId = default(string), bool? skipModule = default(bool?))
        {
            this.Media = media;
        ...
        /// <summary>
        /// User ID to send fax to
        /// </summary>
        /// <value>User ID to send fax to</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsReceiveFax {\n");
        ...
        {
            return this.Equals(input as CallflowsReceiveFax);
        }

        /// <summary>
        /// Returns true if CallflowsReceiveFax instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsReceiveFax to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsReceiveFax input)
        {
            if (input == null)
                return false;
