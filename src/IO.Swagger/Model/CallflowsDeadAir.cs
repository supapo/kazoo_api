...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsDeadAir :  IEquatable<CallflowsDeadAir>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsDeadAir" /> class.
        /// </summary>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsDeadAir(bool? skipModule = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsDeadAir {\n");
        ...
        {
            return this.Equals(input as CallflowsDeadAir);
        }

        /// <summary>
        /// Returns true if CallflowsDeadAir instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsDeadAir to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsDeadAir input)
        {
            if (input == null)
                return false;
