...
{
    /// <summary>
    /// AMQP API for acdc_stats.status_wrapup
    /// </summary>
    [DataContract]
    public partial class KapiAcdcStatsStatusWrapup :  IEquatable<KapiAcdcStatsStatusWrapup>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusWrapup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcStatsStatusWrapup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusWrapup" /> class.
        /// </summary>
        ...
        public KapiAcdcStatsStatusWrapup(string accountID = default(string), string agentID = default(string), string callID = default(string), string callerIDName = default(string), string callerIDNumber = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), int? pauseTime = default(int?), string queueID = default(string), string timestamp = default(string), int? waitTime = default(int?))
        {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcStatsStatusWrapup and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for KapiAcdcStatsStatusWrapup and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcStatsStatusWrapup {\n");
        ...
        {
            return this.Equals(input as KapiAcdcStatsStatusWrapup);
        }

        /// <summary>
        /// Returns true if KapiAcdcStatsStatusWrapup instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcStatsStatusWrapup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcStatsStatusWrapup input)
        {
            if (input == null)
                return false;
