...
{
    /// <summary>
    /// AMQP API for notifications.port_scheduled
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsPortScheduled :  IEquatable<KapiNotificationsPortScheduled>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Portscheduled for value: port_scheduled
            /// </summary>
            [EnumMember(Value = "port_scheduled")]
            Portscheduled = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPortScheduled" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiNotificationsPortScheduled() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPortScheduled" /> class.
        /// </summary>
        ...
        public KapiNotificationsPortScheduled(string accountDB = default(string), string accountID = default(string), string attachmentURL = default(string), string authorizedBy = default(string), string bcc = default(string), string cc = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string from = default(string), string hTML = default(string), string localNumber = default(string), string number = default(string), string numberState = default(string), string port = default(string), string portRequestID = default(string), string preview = default(string), Object reason = default(Object), string replyTo = default(string), string subject = default(string), string text = default(string), string to = default(string), string version = default(string))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiNotificationsPortScheduled and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsPortScheduled {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsPortScheduled);
        }

        /// <summary>
        /// Returns true if KapiNotificationsPortScheduled instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsPortScheduled to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsPortScheduled input)
        {
            if (input == null)
                return false;
