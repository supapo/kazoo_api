...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsBranchBnumber :  IEquatable<CallflowsBranchBnumber>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsBranchBnumber" /> class.
        /// </summary>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsBranchBnumber(bool? skipModule = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsBranchBnumber {\n");
        ...
        {
            return this.Equals(input as CallflowsBranchBnumber);
        }

        /// <summary>
        /// Returns true if CallflowsBranchBnumber instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsBranchBnumber to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsBranchBnumber input)
        {
            if (input == null)
                return false;
