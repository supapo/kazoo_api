...
{
    /// <summary>
    /// AMQP API for notifications.port_comment
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsPortComment :  IEquatable<KapiNotificationsPortComment>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Portcomment for value: port_comment
            /// </summary>
            [EnumMember(Value = "port_comment")]
            Portcomment = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPortComment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiNotificationsPortComment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPortComment" /> class.
        /// </summary>
        ...
        public KapiNotificationsPortComment(string accountDB = default(string), string accountID = default(string), string attachmentURL = default(string), string authorizedBy = default(string), string bcc = default(string), string cc = default(string), string comment = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string from = default(string), string hTML = default(string), string localNumber = default(string), string number = default(string), string numberState = default(string), string port = default(string), string portRequestID = default(string), string preview = default(string), string replyTo = default(string), string request = default(string), string subject = default(string), string text = default(string), string to = default(string), string version = default(string))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiNotificationsPortComment and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsPortComment {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsPortComment);
        }

        /// <summary>
        /// Returns true if KapiNotificationsPortComment instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsPortComment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsPortComment input)
        {
            if (input == null)
                return false;
