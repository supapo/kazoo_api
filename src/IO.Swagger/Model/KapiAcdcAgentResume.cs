...
{
    /// <summary>
    /// AMQP API for acdc_agent.resume
    /// </summary>
    [DataContract]
    public partial class KapiAcdcAgentResume :  IEquatable<KapiAcdcAgentResume>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentResume" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcAgentResume() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentResume" /> class.
        /// </summary>
        ...
        public KapiAcdcAgentResume(string accountID = default(string), string agentID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string presenceID = default(string), PresenceStateEnum? presenceState = default(PresenceStateEnum?), string queueID = default(string), int? timeLimit = default(int?))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiAcdcAgentResume and cannot be null");
            }
            else
            {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcAgentResume and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcAgentResume {\n");
        ...
        {
            return this.Equals(input as KapiAcdcAgentResume);
        }

        /// <summary>
        /// Returns true if KapiAcdcAgentResume instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcAgentResume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcAgentResume input)
        {
            if (input == null)
                return false;
