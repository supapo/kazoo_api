...
{
    /// <summary>
    /// AMQP API for acdc_agent.logout_queue
    /// </summary>
    [DataContract]
    public partial class KapiAcdcAgentLogoutQueue :  IEquatable<KapiAcdcAgentLogoutQueue>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Logoutqueue for value: logout_queue
            /// </summary>
            [EnumMember(Value = "logout_queue")]
            Logoutqueue = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentLogoutQueue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcAgentLogoutQueue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentLogoutQueue" /> class.
        /// </summary>
        ...
        public KapiAcdcAgentLogoutQueue(string accountID = default(string), string agentID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string presenceID = default(string), PresenceStateEnum? presenceState = default(PresenceStateEnum?), string queueID = default(string), int? timeLimit = default(int?))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiAcdcAgentLogoutQueue and cannot be null");
            }
            else
            {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcAgentLogoutQueue and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcAgentLogoutQueue {\n");
        ...
        {
            return this.Equals(input as KapiAcdcAgentLogoutQueue);
        }

        /// <summary>
        /// Returns true if KapiAcdcAgentLogoutQueue instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcAgentLogoutQueue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcAgentLogoutQueue input)
        {
            if (input == null)
                return false;
