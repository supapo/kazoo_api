...
{
    /// <summary>
    /// AMQP API for dialplan.connect_leg
    /// </summary>
    [DataContract]
    public partial class KapiDialplanConnectLeg :  IEquatable<KapiDialplanConnectLeg>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ApplicationNameEnum
        {
            ...
            /// <summary>
            /// Enum Connectleg for value: connect_leg
            /// </summary>
            [EnumMember(Value = "connect_leg")]
            Connectleg = 1
        }
        ...
        protected KapiDialplanConnectLeg() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanConnectLeg" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets PublishUsurp
        /// </summary>
        [DataMember(Name="Publish-Usurp", EmitDefaultValue=false)]
        public bool? PublishUsurp { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanConnectLeg {\n");
            ...
            sb.Append("  PublishUsurp: ").Append(PublishUsurp).Append("\n");
        ...
        {
            return this.Equals(input as KapiDialplanConnectLeg);
        }

        /// <summary>
        /// Returns true if KapiDialplanConnectLeg instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanConnectLeg to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanConnectLeg input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PublishUsurp == input.PublishUsurp ||
                    (this.PublishUsurp != null &&
                    this.PublishUsurp.Equals(input.PublishUsurp))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PublishUsurp != null)
                    hashCode = hashCode * 59 + this.PublishUsurp.GetHashCode();
