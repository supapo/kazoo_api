...
{
    /// <summary>
    /// AMQP API for sysconf.set_resp
    /// </summary>
    [DataContract]
    public partial class KapiSysconfSetResp :  IEquatable<KapiSysconfSetResp>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Setresp for value: set_resp
            /// </summary>
            [EnumMember(Value = "set_resp")]
            Setresp = 1
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiSysconfSetResp {\n");
        ...
        {
            return this.Equals(input as KapiSysconfSetResp);
        }

        /// <summary>
        /// Returns true if KapiSysconfSetResp instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiSysconfSetResp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiSysconfSetResp input)
        {
            if (input == null)
                return false;
