...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConnectivityOptions :  IEquatable<ConnectivityOptions>, IValidatableObject
    {
        /// <summary>
        ...
        public ConnectivityOptionsCallerId CallerId { get; set; }
        ...
        /// <summary>
        /// Whether to allow routing to continue on a non-reconcilable TO number
        /// </summary>
        /// <value>Whether to allow routing to continue on a non-reconcilable TO number</value>
        [DataMember(Name="hunt_non_reconcilable", EmitDefaultValue=false)]
        public bool? HuntNonReconcilable { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConnectivityOptions {\n");
            ...
            sb.Append("  HuntNonReconcilable: ").Append(HuntNonReconcilable).Append("\n");
        ...
        {
            return this.Equals(input as ConnectivityOptions);
        }

        /// <summary>
        /// Returns true if ConnectivityOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectivityOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectivityOptions input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HuntNonReconcilable == input.HuntNonReconcilable ||
                    (this.HuntNonReconcilable != null &&
                    this.HuntNonReconcilable.Equals(input.HuntNonReconcilable))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HuntNonReconcilable != null)
                    hashCode = hashCode * 59 + this.HuntNonReconcilable.GetHashCode();
