...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsEdr :  IEquatable<CallflowsEdr>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsEdr" /> class.
        /// </summary>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsEdr(bool? skipModule = default(bool?))
        {
        ...
        {
            return this.Equals(input as CallflowsEdr);
        }

        /// <summary>
        /// Returns true if CallflowsEdr instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsEdr to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsEdr input)
        {
            if (input == null)
                return false;
