...
{
    /// <summary>
    /// AMQP API for presence.mwi_update
    /// </summary>
    [DataContract]
    public partial class KapiPresenceMwiUpdate :  IEquatable<KapiPresenceMwiUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Mwiupdate for value: mwi_update
            /// </summary>
            [EnumMember(Value = "mwi_update")]
            Mwiupdate = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiPresenceMwiUpdate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiPresenceMwiUpdate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiPresenceMwiUpdate" /> class.
        /// </summary>
        ...
        public KapiPresenceMwiUpdate(string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string expires = default(string), string extendedPresenceID = default(string), string from = default(string), string fromRealm = default(string), string fromUser = default(string), string messageAccount = default(string), int? messagesNew = default(int?), int? messagesSaved = default(int?), int? messagesUrgent = default(int?), int? messagesUrgentSaved = default(int?), string messagesWaiting = default(string), string presenceID = default(string), string to = default(string), string toRealm = default(string), string toUser = default(string))
        {
            ...
            {
                throw new InvalidDataException("messagesSaved is a required property for KapiPresenceMwiUpdate and cannot be null");
            }
            else
            {
            ...
            if (to == null)
            {
                throw new InvalidDataException("to is a required property for KapiPresenceMwiUpdate and cannot be null");
            }
            else
            {
                this.To = to;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiPresenceMwiUpdate {\n");
        ...
        {
            return this.Equals(input as KapiPresenceMwiUpdate);
        }

        /// <summary>
        /// Returns true if KapiPresenceMwiUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiPresenceMwiUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiPresenceMwiUpdate input)
        {
            if (input == null)
                return false;
