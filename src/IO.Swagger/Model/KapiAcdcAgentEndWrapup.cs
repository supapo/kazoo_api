...
{
    /// <summary>
    /// AMQP API for acdc_agent.end_wrapup
    /// </summary>
    [DataContract]
    public partial class KapiAcdcAgentEndWrapup :  IEquatable<KapiAcdcAgentEndWrapup>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Endwrapup for value: end_wrapup
            /// </summary>
            [EnumMember(Value = "end_wrapup")]
            Endwrapup = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentEndWrapup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcAgentEndWrapup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentEndWrapup" /> class.
        /// </summary>
        ...
        public KapiAcdcAgentEndWrapup(string accountID = default(string), string agentID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string presenceID = default(string), PresenceStateEnum? presenceState = default(PresenceStateEnum?), string queueID = default(string), int? timeLimit = default(int?))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiAcdcAgentEndWrapup and cannot be null");
            }
            else
            {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcAgentEndWrapup and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcAgentEndWrapup {\n");
        ...
        {
            return this.Equals(input as KapiAcdcAgentEndWrapup);
        }

        /// <summary>
        /// Returns true if KapiAcdcAgentEndWrapup instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcAgentEndWrapup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcAgentEndWrapup input)
        {
            if (input == null)
                return false;
