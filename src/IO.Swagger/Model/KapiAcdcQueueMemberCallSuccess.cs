...
{
    /// <summary>
    /// AMQP API for acdc_queue.member_call_success
    /// </summary>
    [DataContract]
    public partial class KapiAcdcQueueMemberCallSuccess :  IEquatable<KapiAcdcQueueMemberCallSuccess>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Callsuccess for value: call_success
            /// </summary>
        ...
        protected KapiAcdcQueueMemberCallSuccess() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcQueueMemberCallSuccess" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcQueueMemberCallSuccess {\n");
        ...
        {
            return this.Equals(input as KapiAcdcQueueMemberCallSuccess);
        }

        /// <summary>
        /// Returns true if KapiAcdcQueueMemberCallSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcQueueMemberCallSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcQueueMemberCallSuccess input)
        {
            if (input == null)
                return false;
