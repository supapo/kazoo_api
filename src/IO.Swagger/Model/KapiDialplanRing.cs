...
{
    /// <summary>
    /// AMQP API for dialplan.ring
    /// </summary>
    [DataContract]
    public partial class KapiDialplanRing :  IEquatable<KapiDialplanRing>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanRing" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiDialplanRing() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanRing" /> class.
        /// </summary>
        ...
        public KapiDialplanRing(ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), InsertAtEnum? insertAt = default(InsertAtEnum?), string ringback = default(string))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiDialplanRing and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiDialplanRing and cannot be null");
            }
            else
            {
                this.CallID = callID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanRing {\n");
        ...
        {
            return this.Equals(input as KapiDialplanRing);
        }

        /// <summary>
        /// Returns true if KapiDialplanRing instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanRing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanRing input)
        {
            if (input == null)
                return false;
