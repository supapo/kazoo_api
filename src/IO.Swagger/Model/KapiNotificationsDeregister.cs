...
{
    /// <summary>
    /// AMQP API for notifications.deregister
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsDeregister :  IEquatable<KapiNotificationsDeregister>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsDeregister" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiNotificationsDeregister() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsDeregister" /> class.
        /// </summary>
        ...
        public KapiNotificationsDeregister(string accountDB = default(string), string accountID = default(string), string attachmentURL = default(string), string authorizingID = default(string), string bcc = default(string), string callID = default(string), string cc = default(string), string contact = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string eventTimestamp = default(string), string expires = default(string), string freeSWITCHHostname = default(string), string from = default(string), string fromHost = default(string), string fromUser = default(string), string hTML = default(string), string networkIP = default(string), string networkPort = default(string), string presenceHosts = default(string), string preview = default(string), string profileName = default(string), string rPid = default(string), string realm = default(string), string replyTo = default(string), string status = default(string), string subject = default(string), string suppressUnregisterNotify = default(string), string text = default(string), string to = default(string), string toHost = default(string), string toUser = default(string), string userAgent = default(string), string username = default(string))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiNotificationsDeregister and cannot be null");
            }
            else
            {
            ...
            if (realm == null)
            {
                throw new InvalidDataException("realm is a required property for KapiNotificationsDeregister and cannot be null");
            }
            else
            {
                this.Realm = realm;
            ...
            if (username == null)
            {
                throw new InvalidDataException("username is a required property for KapiNotificationsDeregister and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsDeregister {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsDeregister);
        }

        /// <summary>
        /// Returns true if KapiNotificationsDeregister instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsDeregister to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsDeregister input)
        {
            if (input == null)
                return false;
