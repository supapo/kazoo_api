...
{
    /// <summary>
    /// AMQP API for sms.message
    /// </summary>
    [DataContract]
    public partial class KapiSmsMessage :  IEquatable<KapiSmsMessage>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiSmsMessage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiSmsMessage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiSmsMessage" /> class.
        /// </summary>
        ...
        public KapiSmsMessage(string applicationData = default(string), ApplicationNameEnum applicationName = default(ApplicationNameEnum), string assertedIdentityName = default(string), string assertedIdentityNumber = default(string), string assertedIdentityRealm = default(string), string bLegEvents = default(string), string body = default(string), Object bridgeActions = default(Object), string callID = default(string), string calleeIDName = default(string), string calleeIDNumber = default(string), string callerIDName = default(string), string callerIDNumber = default(string), int? confirmCancelTimeout = default(int?), string confirmFile = default(string), string confirmKey = default(string), string continueAfter = default(string), bool? continueOnFail = default(bool?), Object customApplicationVars = default(Object), Object customChannelVars = default(Object), Object customSIPHeaders = default(Object), DialEndpointMethodEnum? dialEndpointMethod = default(DialEndpointMethodEnum?), string enableT38Fax = default(string), string enableT38FaxRequest = default(string), string enableT38Gateway = default(string), string enableT38Passthrough = default(string), List<KapiDialplanBridgeEndpoint> endpoints = default(List<KapiDialplanBridgeEndpoint>), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string exportBridgeVariables = default(string), string exportVariables = default(string), string failOnSingleReject = default(string), string forceFax = default(string), string fromRealm = default(string), string fromURI = default(string), string fromUser = default(string), string holdMedia = default(string), string ignoreCompletedElsewhere = default(string), string ignoreEarlyMedia = default(string), string ignoreForward = default(string), string insertAt = default(string), string loopbackBowout = default(string), string media = default(string), string messageID = default(string), string outboundCalleeIDName = default(string), string outboundCalleeIDNumber = default(string), string outboundCallerIDName = default(string), string outboundCallerIDNumber = default(string), string privacyHideName = default(string), string privacyHideNumber = default(string), string privacyMethod = default(string), string ringback = default(string), string routeID = default(string), RouteTypeEnum? routeType = default(RouteTypeEnum?), Object sIPHeaders = default(Object), string sIPInviteParameters = default(string), SIPTransportEnum? sIPTransport = default(SIPTransportEnum?), string secureRTP = default(string), string simplifyLoopback = default(string), string timeout = default(string), string toRealm = default(string), string toURI = default(string), string toUser = default(string))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiSmsMessage and cannot be null");
            }
            else
            {
            ...
            if (body == null)
            {
                throw new InvalidDataException("body is a required property for KapiSmsMessage and cannot be null");
            }
            else
            {
                this.Body = body;
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiSmsMessage and cannot be null");
            }
            else
            {
                this.CallID = callID;
            ...
            if (endpoints == null)
            {
                throw new InvalidDataException("endpoints is a required property for KapiSmsMessage and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiSmsMessage {\n");
        ...
        {
            return this.Equals(input as KapiSmsMessage);
        }

        /// <summary>
        /// Returns true if KapiSmsMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiSmsMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiSmsMessage input)
        {
            if (input == null)
                return false;
