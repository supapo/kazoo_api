...
{
    /// <summary>
    /// AMQP API for conference.tones
    /// </summary>
    [DataContract]
    public partial class KapiConferenceTones :  IEquatable<KapiConferenceTones>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ApplicationNameEnum
        {
            ...
            /// <summary>
            /// Enum Tones for value: tones
            /// </summary>
            [EnumMember(Value = "tones")]
            Tones = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiConferenceTones" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiConferenceTones() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiConferenceTones" /> class.
        /// </summary>
        ...
        public KapiConferenceTones(ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), string conferenceID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string groupID = default(string), InsertAtEnum? insertAt = default(InsertAtEnum?), List<TerminatorsEnum> terminators = default(List<TerminatorsEnum>), List<KapiDialplanTonesReqToneHeaders> tones = default(List<KapiDialplanTonesReqToneHeaders>))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiConferenceTones and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiConferenceTones and cannot be null");
            }
            else
            {
                this.CallID = callID;
            ...
            if (tones == null)
            {
                throw new InvalidDataException("tones is a required property for KapiConferenceTones and cannot be null");
            }
            else
            {
                this.Tones = tones;
        ...
        /// Gets or Sets Tones
        /// </summary>
        [DataMember(Name="Tones", EmitDefaultValue=false)]
        public List<KapiDialplanTonesReqToneHeaders> Tones { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiConferenceTones {\n");
            ...
            sb.Append("  Tones: ").Append(Tones).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as KapiConferenceTones);
        }

        /// <summary>
        /// Returns true if KapiConferenceTones instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiConferenceTones to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiConferenceTones input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Tones == input.Tones ||
                    this.Tones != null &&
                    this.Tones.SequenceEqual(input.Tones)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Tones != null)
                    hashCode = hashCode * 59 + this.Tones.GetHashCode();
                return hashCode;
            }
        }
