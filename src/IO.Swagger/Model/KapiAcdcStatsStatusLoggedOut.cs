...
{
    /// <summary>
    /// AMQP API for acdc_stats.status_logged_out
    /// </summary>
    [DataContract]
    public partial class KapiAcdcStatsStatusLoggedOut :  IEquatable<KapiAcdcStatsStatusLoggedOut>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusLoggedOut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcStatsStatusLoggedOut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusLoggedOut" /> class.
        /// </summary>
        ...
        public KapiAcdcStatsStatusLoggedOut(string accountID = default(string), string agentID = default(string), string callID = default(string), string callerIDName = default(string), string callerIDNumber = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), int? pauseTime = default(int?), string queueID = default(string), string timestamp = default(string), int? waitTime = default(int?))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiAcdcStatsStatusLoggedOut and cannot be null");
            }
            else
            {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcStatsStatusLoggedOut and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for KapiAcdcStatsStatusLoggedOut and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcStatsStatusLoggedOut {\n");
        ...
        {
            return this.Equals(input as KapiAcdcStatsStatusLoggedOut);
        }

        /// <summary>
        /// Returns true if KapiAcdcStatsStatusLoggedOut instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcStatsStatusLoggedOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcStatsStatusLoggedOut input)
        {
            if (input == null)
                return false;
