...
{
    /// <summary>
    /// AMQP API for acdc_stats.status_paused
    /// </summary>
    [DataContract]
    public partial class KapiAcdcStatsStatusPaused :  IEquatable<KapiAcdcStatsStatusPaused>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusPaused" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcStatsStatusPaused() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusPaused" /> class.
        /// </summary>
        ...
        public KapiAcdcStatsStatusPaused(string accountID = default(string), string agentID = default(string), string callID = default(string), string callerIDName = default(string), string callerIDNumber = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), int? pauseTime = default(int?), string queueID = default(string), string timestamp = default(string), int? waitTime = default(int?))
        {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcStatsStatusPaused and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for KapiAcdcStatsStatusPaused and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcStatsStatusPaused {\n");
        ...
        {
            return this.Equals(input as KapiAcdcStatsStatusPaused);
        }

        /// <summary>
        /// Returns true if KapiAcdcStatsStatusPaused instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcStatsStatusPaused to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcStatsStatusPaused input)
        {
            if (input == null)
                return false;
