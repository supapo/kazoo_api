...
{
    /// <summary>
    /// AMQP API for resource.eavesdrop_req
    /// </summary>
    [DataContract]
    public partial class KapiResourceEavesdropReq :  IEquatable<KapiResourceEavesdropReq>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Eavesdropreq for value: eavesdrop_req
            /// </summary>
            [EnumMember(Value = "eavesdrop_req")]
            Eavesdropreq = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiResourceEavesdropReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiResourceEavesdropReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiResourceEavesdropReq" /> class.
        /// </summary>
        ...
        public KapiResourceEavesdropReq(string accountID = default(string), string applicationData = default(string), string assertedIdentityName = default(string), string assertedIdentityNumber = default(string), string assertedIdentityRealm = default(string), string bLegEvents = default(string), Object bridgeActions = default(Object), string callRestrictionsEnabled = default(string), string calleeIDName = default(string), string calleeIDNumber = default(string), string callerIDName = default(string), string callerIDNumber = default(string), int? confirmCancelTimeout = default(int?), string confirmFile = default(string), string confirmKey = default(string), string continueAfter = default(string), string continueOnFail = default(string), Object customApplicationVars = default(Object), Object customChannelVars = default(Object), Object customSIPHeaders = default(Object), string dialEndpointMethod = default(string), string eavesdropCallID = default(string), string eavesdropGroupID = default(string), EavesdropModeEnum? eavesdropMode = default(EavesdropModeEnum?), string enableT38Fax = default(string), string enableT38FaxRequest = default(string), string enableT38Gateway = default(string), string enableT38Passthrough = default(string), string endpointID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string existingCallID = default(string), string exportBridgeVariables = default(string), Object exportCustomChannelVars = default(Object), string exportVariables = default(string), string failOnSingleReject = default(string), string faxIdentityName = default(string), string faxIdentityNumber = default(string), string faxTimezone = default(string), string forceFax = default(string), string holdMedia = default(string), string ignoreCompletedElsewhere = default(string), string ignoreEarlyMedia = default(string), string ignoreForward = default(string), string insertAt = default(string), string interceptUnbridgedOnly = default(string), string loopbackBowout = default(string), string media = default(string), string originateImmediate = default(string), string originationCallID = default(string), string outboundCallID = default(string), string outboundCalleeIDName = default(string), string outboundCalleeIDNumber = default(string), string outboundCallerIDName = default(string), string outboundCallerIDNumber = default(string), string privacyHideName = default(string), string privacyHideNumber = default(string), string privacyMethod = default(string), string ringback = default(string), string sIPInviteParameters = default(string), string sIPTransport = default(string), string secureRTP = default(string), string simplifyLoopback = default(string), string startControlProcess = default(string), string timeout = default(string))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiResourceEavesdropReq and cannot be null");
            }
            else
            {
            ...
            if (endpointID == null)
            {
                throw new InvalidDataException("endpointID is a required property for KapiResourceEavesdropReq and cannot be null");
            }
            else
            {
        ...
        public string DialEndpointMethod { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiResourceEavesdropReq {\n");
        ...
        {
            return this.Equals(input as KapiResourceEavesdropReq);
        }

        /// <summary>
        /// Returns true if KapiResourceEavesdropReq instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiResourceEavesdropReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiResourceEavesdropReq input)
        {
            if (input == null)
                return false;
