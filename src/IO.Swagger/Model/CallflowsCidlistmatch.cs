...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsCidlistmatch :  IEquatable<CallflowsCidlistmatch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsCidlistmatch" /> class.
        /// </summary>
        /// <param name="id">CallerID List ID.</param>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsCidlistmatch(string id = default(string), bool? skipModule = default(bool?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CallflowsCidlistmatch {\n");
        ...
        {
            return this.Equals(input as CallflowsCidlistmatch);
        }

        /// <summary>
        /// Returns true if CallflowsCidlistmatch instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsCidlistmatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsCidlistmatch input)
        {
            if (input == null)
                return false;
