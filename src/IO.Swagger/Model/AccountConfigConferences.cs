...
{
    /// <summary>
    /// Schema for conferences account_config
    /// </summary>
    [DataContract]
    public partial class AccountConfigConferences :  IEquatable<AccountConfigConferences>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountConfigConferences {\n");
        ...
        {
            return this.Equals(input as AccountConfigConferences);
        }

        /// <summary>
        /// Returns true if AccountConfigConferences instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountConfigConferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountConfigConferences input)
        {
            if (input == null)
                return false;
