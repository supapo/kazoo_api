...
{
    /// <summary>
    /// AMQP API for dialplan.set_terminators
    /// </summary>
    [DataContract]
    public partial class KapiDialplanSetTerminators :  IEquatable<KapiDialplanSetTerminators>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ApplicationNameEnum
        {
            ...
            /// <summary>
            /// Enum Setterminators for value: set_terminators
            /// </summary>
            [EnumMember(Value = "set_terminators")]
            Setterminators = 1
        }
        ...
        protected KapiDialplanSetTerminators() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanSetTerminators" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanSetTerminators {\n");
        ...
        {
            return this.Equals(input as KapiDialplanSetTerminators);
        }

        /// <summary>
        /// Returns true if KapiDialplanSetTerminators instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanSetTerminators to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanSetTerminators input)
        {
            if (input == null)
                return false;
