...
{
    /// <summary>
    /// AMQP API for notifications.port_pending
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsPortPending :  IEquatable<KapiNotificationsPortPending>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Portpending for value: port_pending
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPortPending" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiNotificationsPortPending() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsPortPending" /> class.
        /// </summary>
        ...
        public KapiNotificationsPortPending(string accountDB = default(string), string accountID = default(string), string attachmentURL = default(string), string authorizedBy = default(string), string bcc = default(string), string cc = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string from = default(string), string hTML = default(string), string localNumber = default(string), string number = default(string), string numberState = default(string), string port = default(string), string portRequestID = default(string), string preview = default(string), Object reason = default(Object), string replyTo = default(string), string subject = default(string), string text = default(string), string to = default(string), string version = default(string))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiNotificationsPortPending and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsPortPending {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsPortPending);
        }

        /// <summary>
        /// Returns true if KapiNotificationsPortPending instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsPortPending to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsPortPending input)
        {
            if (input == null)
                return false;
