...
{
    /// <summary>
    /// AMQP API for acdc_stats.status_update
    /// </summary>
    [DataContract]
    public partial class KapiAcdcStatsStatusUpdate :  IEquatable<KapiAcdcStatsStatusUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusUpdate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcStatsStatusUpdate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusUpdate" /> class.
        /// </summary>
        ...
        public KapiAcdcStatsStatusUpdate(string accountID = default(string), string agentID = default(string), string callID = default(string), string callerIDName = default(string), string callerIDNumber = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), Object eventName = default(Object), int? pauseTime = default(int?), string queueID = default(string), string timestamp = default(string), int? waitTime = default(int?))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiAcdcStatsStatusUpdate and cannot be null");
            }
            else
            {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcStatsStatusUpdate and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for KapiAcdcStatsStatusUpdate and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcStatsStatusUpdate {\n");
        ...
        {
            return this.Equals(input as KapiAcdcStatsStatusUpdate);
        }

        /// <summary>
        /// Returns true if KapiAcdcStatsStatusUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcStatsStatusUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcStatsStatusUpdate input)
        {
            if (input == null)
                return false;
