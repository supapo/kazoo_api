...
{
    /// <summary>
    /// AMQP API for acdc_stats.status_connected
    /// </summary>
    [DataContract]
    public partial class KapiAcdcStatsStatusConnected :  IEquatable<KapiAcdcStatsStatusConnected>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusConnected" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcStatsStatusConnected() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcStatsStatusConnected" /> class.
        /// </summary>
        ...
        public KapiAcdcStatsStatusConnected(string accountID = default(string), string agentID = default(string), string callID = default(string), string callerIDName = default(string), string callerIDNumber = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), int? pauseTime = default(int?), string queueID = default(string), string timestamp = default(string), int? waitTime = default(int?))
        {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcStatsStatusConnected and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for KapiAcdcStatsStatusConnected and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcStatsStatusConnected {\n");
        ...
        {
            return this.Equals(input as KapiAcdcStatsStatusConnected);
        }

        /// <summary>
        /// Returns true if KapiAcdcStatsStatusConnected instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcStatsStatusConnected to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcStatsStatusConnected input)
        {
            if (input == null)
                return false;
