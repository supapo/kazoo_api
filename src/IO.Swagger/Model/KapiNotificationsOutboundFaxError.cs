...
{
    /// <summary>
    /// AMQP API for notifications.outbound_fax_error
    /// </summary>
    [DataContract]
    public partial class KapiNotificationsOutboundFaxError :  IEquatable<KapiNotificationsOutboundFaxError>, IValidatableObject
    {
        /// <summary>
        ...
        public enum EventNameEnum
        {
            ...
            /// <summary>
            /// Enum Outboundfaxerror for value: outbound_fax_error
            /// </summary>
            [EnumMember(Value = "outbound_fax_error")]
            Outboundfaxerror = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsOutboundFaxError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiNotificationsOutboundFaxError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiNotificationsOutboundFaxError" /> class.
        /// </summary>
        ...
        public KapiNotificationsOutboundFaxError(string accountDB = default(string), string accountID = default(string), string attachmentURL = default(string), string bcc = default(string), string callID = default(string), string calleeIDName = default(string), string calleeIDNumber = default(string), string callerIDName = default(string), string callerIDNumber = default(string), string cc = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string faxError = default(string), string faxID = default(string), string faxInfo = default(string), string faxJobId = default(string), string faxNotifications = default(string), string faxTimestamp = default(string), string faxBoxID = default(string), string from = default(string), string hTML = default(string), string ownerID = default(string), string preview = default(string), string replyTo = default(string), string subject = default(string), string text = default(string), string to = default(string))
        {
            ...
            if (faxJobId == null)
            {
                throw new InvalidDataException("faxJobId is a required property for KapiNotificationsOutboundFaxError and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiNotificationsOutboundFaxError {\n");
        ...
        {
            return this.Equals(input as KapiNotificationsOutboundFaxError);
        }

        /// <summary>
        /// Returns true if KapiNotificationsOutboundFaxError instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiNotificationsOutboundFaxError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiNotificationsOutboundFaxError input)
        {
            if (input == null)
                return false;
