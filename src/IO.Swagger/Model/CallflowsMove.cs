...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CallflowsMove :  IEquatable<CallflowsMove>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallflowsMove" /> class.
        /// </summary>
        /// <param name="skipModule">When set to true this callflow action is skipped, advancing to the wildcard branch (if any).</param>
        public CallflowsMove(bool? skipModule = default(bool?))
        {
        ...
        {
            return this.Equals(input as CallflowsMove);
        }

        /// <summary>
        /// Returns true if CallflowsMove instances are equal
        /// </summary>
        /// <param name="input">Instance of CallflowsMove to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallflowsMove input)
        {
            if (input == null)
                return false;
