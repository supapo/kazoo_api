...
{
    /// <summary>
    /// AMQP API for dialplan.hold
    /// </summary>
    [DataContract]
    public partial class KapiDialplanHold :  IEquatable<KapiDialplanHold>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanHold" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiDialplanHold() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanHold" /> class.
        /// </summary>
        ...
        public KapiDialplanHold(ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string holdMedia = default(string), InsertAtEnum? insertAt = default(InsertAtEnum?))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiDialplanHold and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiDialplanHold and cannot be null");
            }
            else
            {
                this.CallID = callID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanHold {\n");
        ...
        {
            return this.Equals(input as KapiDialplanHold);
        }

        /// <summary>
        /// Returns true if KapiDialplanHold instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanHold to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanHold input)
        {
            if (input == null)
                return false;
