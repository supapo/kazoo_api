...
{
    /// <summary>
    /// AMQP API for dialplan.echo
    /// </summary>
    [DataContract]
    public partial class KapiDialplanEcho :  IEquatable<KapiDialplanEcho>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanEcho" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiDialplanEcho() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanEcho" /> class.
        /// </summary>
        ...
        public KapiDialplanEcho(ApplicationNameEnum applicationName = default(ApplicationNameEnum), string callID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), InsertAtEnum? insertAt = default(InsertAtEnum?))
        {
            // to ensure "applicationName" is required (not null)
            if (applicationName == null)
            {
                throw new InvalidDataException("applicationName is a required property for KapiDialplanEcho and cannot be null");
            }
            else
            {
            ...
            if (callID == null)
            {
                throw new InvalidDataException("callID is a required property for KapiDialplanEcho and cannot be null");
            }
            else
            {
                this.CallID = callID;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanEcho {\n");
        ...
        {
            return this.Equals(input as KapiDialplanEcho);
        }

        /// <summary>
        /// Returns true if KapiDialplanEcho instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanEcho to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanEcho input)
        {
            if (input == null)
                return false;
