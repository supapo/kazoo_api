...
{
    /// <summary>
    /// AMQP API for dialplan.eavesdrop
    /// </summary>
    [DataContract]
    public partial class KapiDialplanEavesdrop :  IEquatable<KapiDialplanEavesdrop>, IValidatableObject
    {
        /// <summary>
        ...
        protected KapiDialplanEavesdrop() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiDialplanEavesdrop" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets EnableDTMF
        /// </summary>
        [DataMember(Name="Enable-DTMF", EmitDefaultValue=false)]
        public string EnableDTMF { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiDialplanEavesdrop {\n");
            ...
            sb.Append("  EnableDTMF: ").Append(EnableDTMF).Append("\n");
        ...
        {
            return this.Equals(input as KapiDialplanEavesdrop);
        }

        /// <summary>
        /// Returns true if KapiDialplanEavesdrop instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiDialplanEavesdrop to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiDialplanEavesdrop input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EnableDTMF == input.EnableDTMF ||
                    (this.EnableDTMF != null &&
                    this.EnableDTMF.Equals(input.EnableDTMF))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnableDTMF != null)
                    hashCode = hashCode * 59 + this.EnableDTMF.GetHashCode();
