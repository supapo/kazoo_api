...
{
    /// <summary>
    /// AMQP API for acdc_agent.login
    /// </summary>
    [DataContract]
    public partial class KapiAcdcAgentLogin :  IEquatable<KapiAcdcAgentLogin>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentLogin" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KapiAcdcAgentLogin() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KapiAcdcAgentLogin" /> class.
        /// </summary>
        ...
        public KapiAcdcAgentLogin(string accountID = default(string), string agentID = default(string), EventCategoryEnum? eventCategory = default(EventCategoryEnum?), EventNameEnum? eventName = default(EventNameEnum?), string presenceID = default(string), PresenceStateEnum? presenceState = default(PresenceStateEnum?), string queueID = default(string), int? timeLimit = default(int?))
        {
            // to ensure "accountID" is required (not null)
            if (accountID == null)
            {
                throw new InvalidDataException("accountID is a required property for KapiAcdcAgentLogin and cannot be null");
            }
            else
            {
            ...
            if (agentID == null)
            {
                throw new InvalidDataException("agentID is a required property for KapiAcdcAgentLogin and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KapiAcdcAgentLogin {\n");
        ...
        {
            return this.Equals(input as KapiAcdcAgentLogin);
        }

        /// <summary>
        /// Returns true if KapiAcdcAgentLogin instances are equal
        /// </summary>
        /// <param name="input">Instance of KapiAcdcAgentLogin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KapiAcdcAgentLogin input)
        {
            if (input == null)
                return false;
