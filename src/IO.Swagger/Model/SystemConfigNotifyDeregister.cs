...
{
    /// <summary>
    /// Schema for notify.deregister system_config
    /// </summary>
    [DataContract]
    public partial class SystemConfigNotifyDeregister :  IEquatable<SystemConfigNotifyDeregister>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemConfigNotifyDeregister" /> class.
        /// </summary>
        /// <param name="defaultTo">notify.deregister default to.</param>
        /// <param name="htmlContentTransferEncoding">notify.deregister html content transfer encoding (default to &quot;7BIT&quot;).</param>
        /// <param name="textContentTransferEncoding">notify.deregister text content transfer encoding (default to &quot;7BIT&quot;).</param>
        public SystemConfigNotifyDeregister(Object defaultTo = default(Object), string htmlContentTransferEncoding = "7BIT", string textContentTransferEncoding = "7BIT")
        {
        ...
        /// <summary>
        /// notify.deregister default to
        /// </summary>
        /// <value>notify.deregister default to</value>
        [DataMember(Name="default_to", EmitDefaultValue=false)]
        public Object DefaultTo { get; set; }

        /// <summary>
        /// notify.deregister html content transfer encoding
        /// </summary>
        /// <value>notify.deregister html content transfer encoding</value>
        [DataMember(Name="html_content_transfer_encoding", EmitDefaultValue=false)]
        public string HtmlContentTransferEncoding { get; set; }

        /// <summary>
        /// notify.deregister text content transfer encoding
        /// </summary>
        /// <value>notify.deregister text content transfer encoding</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemConfigNotifyDeregister {\n");
        ...
        {
            return this.Equals(input as SystemConfigNotifyDeregister);
        }

        /// <summary>
        /// Returns true if SystemConfigNotifyDeregister instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemConfigNotifyDeregister to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemConfigNotifyDeregister input)
        {
            if (input == null)
                return false;
