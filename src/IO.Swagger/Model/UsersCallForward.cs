...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersCallForward :  IEquatable<UsersCallForward>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersCallForward" /> class.
        /// </summary>
        ...
        public UsersCallForward(bool? directCallsOnly = false, bool? enabled = false, bool? failover = false, bool? ignoreEarlyMedia = true, bool? keepCallerId = true, string number = default(string), bool? requireKeypress = true, bool? substitute = true)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UsersCallForward {\n");
        ...
        {
            return this.Equals(input as UsersCallForward);
        }

        /// <summary>
        /// Returns true if UsersCallForward instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersCallForward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersCallForward input)
        {
            if (input == null)
                return false;
